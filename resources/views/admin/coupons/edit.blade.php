...
@section('content')
    <div class="main-content-inner">
        <div class="main-content-wrap">
            ...
            <div class="wg-box">
                {{-- Form to add coupons --}}
                <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupons.update',$coupon->id) }}">
                    @csrf
                    @method('PUT')
                    ...
                    @error('code') <span class="text-center alert alert-danger">{{ $message }}</span> @enderror
                    ...
                    @error('type') <span class="text-center alert alert-danger">{{ $message }}</span> @enderror
                    ...
                    @error('value') <span class="text-center alert alert-danger">{{ $message }}</span> @enderror
                    ...
                    @error('cart_value') <span class="text-center alert alert-danger">{{ $message }}</span> @enderror
                    ...
                    @error('expiry_date') <span class="text-center alert alert-danger">{{ $message }}</span> @enderror
