...
@section('content')
  <style>
    .text-success {
      color: #63e934 !important;
    }

    .text-danger {
    color: #e92312 !important;
    }
  </style>
    <main class="pt-90">
        ...
        @if($items->count()>0)
          <div class="cart-table__wrapper">
            <table class="cart-table">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {{-- Form to remove a single cart item --}}
            ...
            <div class="cart-table-footer">
              ...
              {{-- Form to remove Coupon from an item --}}
...
@push('scripts')
  <script>
    $(function() {
      ...
      $(".qty-control_increase").on("click", function() {
        $(this).closest('form').submit();
      });

      $(".qty-control_reduce").on("click", function() {
        $(this).closest('form').submit();
      });

      $(".remove-cart").on("click", function(e) {
        e.preventDefault();  // prevent link from doing nothing
        $(this).closest('form').submit();
      });
