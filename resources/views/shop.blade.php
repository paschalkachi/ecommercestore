...
@section('content')
  <style>
    ...
    <section class="shop-main container d-flex pt-4 pt-xl-5">
                  ...
                  @foreach ($categories as $category)
                    <li class="list-item">
                      <span class="menu-link py-1">
                       ...
                       @if(in_array($category->id, explode(',', $if_categories ?? ''))) checked="checked" @endif>
                        {{ $category->name }}
                      </span>
                  ...
                  @foreach ($brands as $brand)
                    <li class="list-item">
                      <span class="menu-link py-1">
                       ...
                       @if(in_array($brand->id, explode(',', $if_brands ?? ''))) checked="checked" @endif>
                        {{ $brand->name }}
                      </span>
                      <span class="text-right float-end">
      ...
      <div class="shop-list flex-grow-1" style="margin-top: 50px">
        ...
        <div class="d-flex justify-content-between mb-4 pb-md-2">
          ...
          <div class="shop-acs d-flex align-items-center justify-content-between justify-content-md-end flex-grow-1">
            <select class="shop-acs__select form-select w-auto border-0 py-0 order-1 order-md-0" aria-label="Page Size" style="margin-right: 20px;" id="pagesize" name="pagesize">
           ...
           <div class="product-card-wrapper">
            <div class="product-card mb-3 mb-md-4 mb-xxl-5">
              ...
              <div class="pc__info position-relative">
                ...
                @endphp
                @if($wishlistItem)
                    <form action="{{ route('wishlist.item.remove',  $wishlistItem->rowId) }}" method="POST">
                        @csrf
                        @method('DELETE')
       ...
       <div class="divider"></div>
        <div class="flex item-center justify-between flex-wrap gap10 wcp-pagination">
